...
public class Game {
	...
	public void initializeGame() {
		...
		p1 = new Player(1, "Player 1", 0, 0, list, guis); // the name would be given from the initial start by the GUI - done later
		players.add(p1);
		...
		// Adds Player 2
		p2 = new Player(2, "Player 2", 0, 0, list, guis);
		players.add(p2);
		...
		// Adds Player 3
		p3 = new Player(3, "Player 3", 0, 0, list, guis);
		players.add(p3);
		...
		// Adds Player 4
		p4 = new Player(4, "Player 4", 0, 0, list, guis);
		players.add(p4);
